                ...
                <div className="wrapper" ref={ref}>
                    ...
                    >
                        <div className="myname">
                            ...
                            <AnimatedTextCharacter text="Himanshu Kapoor" cl="name" />

                        </div>
                        <motion.h1 className='skill' variants={textVariants}>Web Developer</motion.h1>
                        <motion.div variants={textVariants} className="buttons">
                            <motion.button variants={textVariants}>
                                <a href="https://drive.google.com/file/d/1yQ8-E9GpeV6CWdpj2rLr4uVbZWLa6Aio/view?usp=sharing" target="_blank">Resume</a>
                            </motion.button>
                            <motion.button variants={textVariants}>
